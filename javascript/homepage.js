...
const westernWearImg = ['https://assets.myntassets.com/f_webp,w_196,c_limit,fl_progressive,dpr_2.0/assets/images/2020/7/28/655751e9-66c3-49b5-acfc-a508068e6e581595936000398-Content-westernwear-Trends-Vibrantcolourblocks.jpg',
...
const indianWearTrending = ['https://assets.myntassets.com/f_webp,w_196,c_limit,fl_progressive,dpr_2.0/assets/images/2020/8/19/a9f68785-e282-425a-b270-c978c387b0f31597840342635-Content-ethnicwear-color-whites.jpg',
...
const sportsWear = ['https://assets.myntassets.com/f_webp,w_196,c_limit,fl_progressive,dpr_2.0/assets/images/2020/8/19/8becef46-f822-4874-b92a-a7cc7f58819d1597841103131-Content-sportswear-brand-nike.png',
...
const footWear = ['https://assets.myntassets.com/f_webp,w_196,c_limit,fl_progressive,dpr_2.0/assets/images/2020/7/28/647e166b-f645-443a-892d-df84ee345e781595935221231-Content-Footwear-men-Neutral-shades.jpg',
...
const accessories = ['https://assets.myntassets.com/f_webp,w_196,c_limit,fl_progressive,dpr_2.0/assets/images/2020/7/28/2bcf907c-bc21-44cb-9021-7575a963b0ef1595934830671-Content-Accesories-Unisex-True-wirless-lets-get-free.jpg',
...
//western wear
let westernWear = document.querySelector('.western-wear-images');

let imgComponent = "";
westernWearImg.forEach(item=>{
    imgComponent+= `
        <a href=""><img class="western-img" src=${item}></img></a>`
})

westernWear.innerHTML = imgComponent;

///indian wear
let indianWear = document.querySelector('.indian-wear-images');

let indianImgComponent = "";
indianWearTrending.forEach(item=>{
    indianImgComponent+=`<a href=""><img class="indian-img" src=${item}></img></a>`
})

indianWear.innerHTML = indianImgComponent;


//sports-wear
let sportsWearImg = document.querySelector('.sports-wear-images');
let sportsImgComponent = "";

sportsWear.forEach(item=>{
    sportsImgComponent+= `<a href=""><img class="sports-img" src=${item}></img></a>`
})

sportsWearImg.innerHTML = sportsImgComponent;

//footwear
let footWearImg = document.querySelector('.footwear-images');
let footWearImgComponent = "";

footWear.forEach(item=>{
    footWearImgComponent+= `<a href=""><img class="footwear-img" src=${item}></img></a>`
})

footWearImg.innerHTML = footWearImgComponent;

//accessories
let accessoriesImg = document.querySelector('.accessories-images');
let accessoriesImgComponent = "";

accessories.forEach(item=>{
    accessoriesImgComponent+= `<a href=""><img class="accessories-img" src=${item}></img></a>`;
})

accessoriesImg.innerHTML = accessoriesImgComponent;